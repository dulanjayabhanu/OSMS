...
if(isset($_GET["email"])){
    ...
    $teacherHasSubjectResultset = Database::search("SELECT * FROM `teacher_has_subject` WHERE `teacher_email`='".$email."'");
    ...
    ?>
            ...
            ?>
                        ...
                        <div class="col-3"><button class="border-0 bg-transparent" onclick="removeClassAndSubjectCard('<?php echo($teacherHasSubjectData['id']); ?>'); loadClassAndSubjectCard();"><i class="bi bi-x-circle-fill fs-5 text-primary"></i></button></div>
                    </div>
                </div>
            </div>
            <!-- class and subject card -->
