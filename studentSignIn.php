...
?>
        ...
        <head>
            ...
            <title>Student SignIn - Online Student Management System</title>
                            ...
                            <div class="offset-lg-2 offset-1 col-10 col-lg-8 def-card pt-3 ps-2 pe-2 pb-3 mt-5">
                                <div class="row g-1">
                                    <div class="col-12 text-center border-bottom">
                                        <h2 class="pb-2">Student SignIn</h2>
                                    </div>
                                    <div class="col-12 p-2 mt-2">
                                        <div class="row">
                                            ...
                                            <div class="offset-0 offset-lg-4 col-12 col-lg-4 d-grid mt-3">
                                                <button class="def-btn def-btn-primary text-white" onclick="studentFirstSignIn();">SignIn</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="offset-0 offset-lg-1 col-12 col-lg-10 mt-2">
                                            <div class="row">
                                                ...
                                                <div class="col-12 d-grid">
                                                    <?php
                                                    if (isset($_COOKIE["stu-username"])) {
                                                    ?>
                                                        <input class="def-input" type="text" value="<?php echo ($_COOKIE["stu-username"]); ?>" id="username2" />
                                                    <?php
                                                    } else {
                                                    ?>
                                                ...
                                                <div class="col-12">
                                                    <div class="row g-2">
                                                        <div class="col-10 d-grid">
                                                            ...
                                                            ?>
                                                                <input class="def-input" type="password" value="<?php echo ($_COOKIE["stu-password"]); ?>" id="password2" />
                                                            <?php
                                                            } else {
                                                            ?>
                                        ...
                                        <div class="offset-0 offset-lg-1 col-12 col-lg-10 mt-2">
                                            <div class="row pt-2">
                                                ...
                                                <div class="col-6 text-end">
                                                    <a href="#" class="link text-decoration-none" onclick="studentPasswordVerify();">Forgot Password</a>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="offset-0 offset-lg-4 col-12 col-lg-4 d-grid mt-3">
                                            <button class="def-btn def-btn-primary text-white" onclick="studentSignIn();">SignIn</button>
                                        </div>
                                    </div>
                                </div>
                                <!-- Teacher signin content -->
                                ...
                                <div class="col-12 p-2 mt-2 d-none" id="verify">
                                    <div class="row">
                                        ...
                                        <div class="offset-0 offset-lg-1 col-12 col-lg-10 d-grid mt-2 mt-lg-3">
                                            <button class="def-btn def-btn-primary text-white" onclick="studentAddPasswordVerify();">Verify</button>
                                        </div>
                                        <div class="offset-0 offset-lg-1 col-12 col-lg-10 d-grid mt-2 mt-lg-3">
