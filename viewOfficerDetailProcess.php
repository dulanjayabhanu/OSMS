...
if (isset($_GET["email"])) {
    ...
    $officerProfileResultset = Database::search("SELECT * FROM `teacher_profile_image` WHERE `teacher_email`='" . $officerData["email"] . "'");
?>
    <!-- Teacher detail area -->
    ...
    <div class="col-12 pt-3 pb-3 d-flex flex-row justify-content-center align-items-center">
        ...
        ?>
            <div class="col-md-4 d-flex flex-row justify-content-center align-items-center">
                <img src="<?php echo ($officerProfileData["path"]); ?>" class="img-thumbnail border-1" style="border-radius: 100%;height:120px;width:120px;box-shadow: 0px 2px 3px 1px rgba(19, 70, 129, 0.5);" />
            </div>
        <?php
        } else {
        ?>
    ...
    <div class="col-12 text-center">
        <span class="text-black text-capitalize fs-5" data-bs-toggle="tooltip" id="tooltip" data-bs-placement="right" title="Verifed" style="font-family: 'quicksand-bold';"><?php echo ($officerData["first_name"] . " " . $officerData["last_name"]);
                                                                                                                                                                                if ($officerData["verify_status"] == 1) {
                                                                                                                                                                                ?>
            ...
            <?php
                                                                                                                                                                                } else if ($officerData["verify_status"] == 2) {
            ?>
    ...
    <div class="offset-4 col-4 d-grid pt-2 pb-1">
        <?php
        if ($officerData["block_status"] == 1) {
        ?>
            <button class="def-btn def-btn-danger text-white" id="block-btn" onclick="blockOfficer('<?php echo ($officerData['email']) ?>');"><i class="bi bi-exclamation-circle text-white"></i>&nbsp;&nbsp;Block</button>
        <?php
        } else if ($officerData["block_status"] == 2) {
        ?>
            <button class="def-btn def-btn-success text-white" id="block-btn" onclick="blockOfficer('<?php echo ($officerData['email']) ?>');"><i class="bi bi-check2-circle text-white"></i>&nbsp;&nbsp;Unblock</button>
        <?php
        }
        ?>
    </div>
        ...
        <div class="row g-1">
            <div class="col-12 p-2">
                <div class="row">
                    ...
                    <div class="col-7">
                        <span class="form-label text-primary"><?php echo ($officerData["first_name"]); ?></span>
                    </div>
                </div>
            </div>
            <div class="col-12 p-2">
                <div class="row">
                    ...
                    <div class="col-7">
                        <span class="form-label text-primary"><?php echo ($officerData["last_name"]); ?></span>
                    </div>
                </div>
            </div>
            <div class="col-12 p-2">
                <div class="row">
                    ...
                    <div class="col-7">
                        <span class="form-label text-primary"><?php echo ($officerData["mobile"]); ?></span>
                    </div>
                </div>
            </div>
            <div class="col-12 p-2">
                <div class="row">
                    ...
                    <div class="col-7">
                        <span class="form-label text-primary"><?php echo ($officerData["email"]); ?></span>
                    </div>
                </div>
            </div>
            <div class="col-12 p-2">
                <div class="row">
                    ...
                    <div class="col-7">
                        <span class="form-label text-primary"><?php echo ($officerData["joined_date"]); ?></span>
                    </div>
                </div>
            </div>
            <div class="col-12 p-2">
                <div class="row">
                    ...
                    <div class="col-7">
                        ...
                        district.province_id=province.id WHERE `teacher_email`='" . $officerData["email"] . "'");
