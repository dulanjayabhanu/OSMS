...
?>
    ...
    <head>
        ...
        <title>Manage Students - Online Student Management System</title>
                        ...
                        <div class="col-12 p-2 pb-2" style="background-color: #e5fdff;height:80%;">
                            <div class="nav flex-column nav-pills mt-2" role="tablist" aria-orientation="vertical">
                                <nav class="nav flex-column gap-2 p-2">
                                    ...
                                    <a class="fw-bold def-btn def-btn-primary-active text-decoration-none text-center text-lg-start text-capitalize text-white" aria-current="page" href="manageStudents.php"><i class="bi bi-people fs-5 fw-bold text-white"></i>&nbsp;&nbsp;&nbsp;Students</a>
                ...
                <div class="col-12 col-lg-10">
                    <div class="row">
                        ...
                        <div class="col-12 my-auto p-3" style="background-color: #e5fdff;z-index: 1;">
                            <span class="text-black fs-1"><i class="fs-1 bi bi-people"></i>&nbsp;&nbsp;Manage Students</span>
                        </div>
                                ...
                                <div class="card def-card border-0 ps-5 pe-5 pb-4 pt-2">
                                    <div class="row">
                                        <div class="col-12 text-center pb-3 border-bottom">
                                            <span class="fs-3">Update Student Grade</span>
                                        </div>
                                        <div class="col-12 col-lg-6 d-grid mt-0 mt-lg-4">
                                            <input type="text" class="def-input bg-body my-auto" placeholder="Search By Student's Name..." id="stname" />
                                        </div>
                                        ...
                                        <div class="col-12 col-lg-3 d-grid mt-2 mt-lg-4">
                                            <button class="def-btn def-btn-primary text-white" onclick="searchStudent();"><i class="bi bi-search text-white fs-6"></i>&nbsp;&nbsp;Search Student</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                                    ...
                                                    <div class="col-12 p-3 def-card bg-white">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-12 col-lg-3 d-grid mt-2 mt-lg-0">
                                                                <span style="font-family: 'quicksand-bold';">Update Class To</span>
                                                            </div>
                                                            <div class="col-12 col-lg-3 d-grid mt-2 mt-lg-0">
                                                                <span style="font-family: 'quicksand-bold';">Update Student</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <!-- Student card -->
                                                <div class="row p-0 m-0" id="student-card-loader">
                                                    <!-- Student empty card -->
                                                    <div class="col-12 p-2">
