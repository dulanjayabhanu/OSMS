                    ...
                    <div class="row" style="height: 100vh;">
                        <div class="col-12" style="height:40%;background-image: linear-gradient(24deg, #3972eb, #59ccfa);background-repeat: no-repeat;">
                            <div class="row">
                                ...
                                <?php
                                    $officerResultset = Database::search("SELECT * FROM `teacher` WHERE `user_type`='2' AND `email`='".$officer["email"]."'");
                                    $officerData = $officerResultset->fetch_assoc();
                                    ?>
                                <div class="col-12 text-center pb-2">
                                    <span class="text-white text-capitalize fs-5" data-bs-toggle="tooltip" id="tooltip" data-bs-placement="right" title="Verifed" style="font-family: 'quicksand-bold';"><?php echo ($officerData["first_name"] . " " . $officerData["last_name"]); ?><?php if ($officerData["verify_status"] == "1") {
                                                                                                                                                                                                                                                                                ?>
                        ...
                        <div class="col-12 p-2 pb-2" style="background-color: #e5fdff;height:80%;">
                            <div class="nav flex-column nav-pills mt-2" role="tablist" aria-orientation="vertical">
                                <nav class="nav flex-column gap-2 p-2">
                                    <a class="fw-bold def-btn def-btn-primary text-decoration-none text-center text-lg-start text-capitalize text-white" aria-current="page" href="academicOfficerDashboard.php"><i class="bi bi-pencil-square fs-5 fw-bold text-white"></i>&nbsp;&nbsp;&nbsp;My Dashboard</a>
                                    <a class="fw-bold def-btn def-btn-primary-active text-decoration-none text-center text-lg-start text-capitalize text-white" aria-current="page" href="academicOfficerProfile.php"><i class="bi bi-person fs-5 fw-bold text-white"></i>&nbsp;&nbsp;&nbsp;My Profile</a>
                            ...
                            <div class="row g-1 pb-3">
                                <div class="offset-1 col-10 def-card p-4">
                                    <div class="col-12 d-flex flex-row justify-content-center align-items-center pt-2">
                                        ...
                                        if ($officerProfileRownumber > 0) {
                                        ?>
                                            <img src="<?php echo ($officerProfileData["path"]); ?>" class="img-thumbnail border-0 p-2" id="image" style="max-width:150px;height: 150px;border-radius:100%;box-shadow: 0px 2px 3px 1px rgba(19, 70, 129, 0.5);" />
                                        <?php
                                        } else {
                                        ?>
                                    ...
                                    <div class="col-12 text-center p-1 mt-2">
                                        <span class="badge rounded-pill text-white fs-5 mt-3 mb-2" style="padding-left: 11px;padding-right:11px;padding-top:4px;padding: bottom 4px;background-image: linear-gradient(24deg, #3972eb, #59ccfa);">Academic Officer</span>
                                        <h1 class="text-capitalize fs-2" style="font-family: 'quicksand-bold';"><?php echo ($officerData["first_name"] . " " . $officerData["last_name"]); ?>&nbsp;<i class="bi bi-patch-check-fill fs-4 fw-bold" data-bs-toggle="tooltip" id="tooltip" data-bs-placement="right" title="Verifed" style="color: #34aedf;"></i></h1>
                                        <h4 class="text-primary fs-5"><?php echo ($officerData["email"]); ?></h4>
                                    </div>
                                        ...
                                        <div class="row g-1">
                                            <div class="col-12 col-lg-6 p-3">
                                                ...
                                                <div class="col-12 d-grid">
                                                    <input type="text" class="def-input text-capitalize bg-white" id="fname" value='<?php echo ($officerData["first_name"]); ?>' />
                                                </div>
                                            </div>
                                            <div class="col-12 col-lg-6 p-3">
                                                <div class="col-12">
                                                ...
                                                <div class="col-12 d-grid">
                                                    <input type="text" class="def-input text-capitalize bg-white" id="lname" value='<?php echo ($officerData["last_name"]); ?>' />
                                                </div>
                                            </div>
                                            <div class="col-12 col-lg-6 p-3">
                                                <div class="col-12">
                                                ...
                                                <div class="col-12 d-grid">
                                                    <input type="text" class="def-input bg-white" id="mobile" value='<?php echo ($officerData["mobile"]); ?>' />
                                                </div>
                                            </div>
                                            <div class="col-12 col-lg-6 p-3">
                                                <div class="col-12">
                                                ...
                                                <div class="col-12 d-grid">
                                                    <input type="text" class="def-input bg-white" value='<?php echo ($officerData["joined_date"]); ?>' disabled />
                                                </div>
                                            </div>
                                            <div class="col-12 col-lg-6 p-3">
                                                <div class="col-12">
                                                ...
                                                <div class="col-12 d-grid">
                                                    <input type="text" class="def-input bg-white" value='<?php echo ($officerData["email"]); ?>' disabled />
                                                </div>
                                            </div>
                                            <div class="col-12 col-lg-6 p-3">
                                                <div class="col-12">
                                                ...
                                                <div class="col-12 d-grid">
                                                    <select class="def-input bg-white" disabled>
                                                        <?php
                                                        $genderResultset = Database::search("SELECT * FROM `gender` WHERE `id`='" . $officerData["gender_id"] . "'");
                                            ...
                                            <div class="col-6 col-lg-4 d-grid offset-3 offset-lg-4 mt-3 pb-3">
                                                <button class="def-btn def-btn-primary text-white" onclick="updateOfficerProfile();">Update Profile</button>
                                            </div>
